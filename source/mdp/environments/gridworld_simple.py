...
class Gridworld_Simple(Environment):
    """
    ...
    def __init__(self, startState=0, endState=2, shape=(2, 2), obstacles=[3], waterStates=[1]):
    ...
    def step(self, action: int) -> Tuple[int, float, bool]:
        ...
        self._isEnd = (self._isEnd or self._step > 15)
